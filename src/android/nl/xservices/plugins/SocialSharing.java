        ...
        if (appPackageName != null) {
          ...
          if (activity != null) {
            if (peek) {
              ...
              // Android 13 blocks intents that don't match with the receiving app
              // intent-filters
              // In order to prevent ActivityNotFoundException the category is added to the
              // intent only on Android 12L and below
